...
static int input_stream_on_write(struct input_stream_t* _this,
                                 ...
                                 unsigned int _size) {
    int r;
    struct posix_serial_port_t* psp = container_of(_this, struct posix_serial_port_t, input_stream);
...
static int output_stream_on_read(struct output_stream_t* _this,
                          void* _data,
                          unsigned int _size) {
    struct posix_serial_port_t* psp = container_of(_this, struct posix_serial_port_t, output_stream);
    return read(psp->f, _data, _size);
}

static void fd_event(evutil_socket_t fd, short what, void *arg) {
    struct posix_serial_port_t* _this = (struct posix_serial_port_t*)arg;
...
int posix_serial_port_open(struct posix_serial_port_t* _psp,
    ...
    // Disable hardware flow control
        ...
        if((r = posix_serial_port_set_baudrate(_psp, _baudrate))) {
